...
knitr::read_chunk("05-results/WKBBS-compare/compare-nsp.R")
#source(here("06-misc/WKBBS-compare/compare-nsp.R"))
...
knitr::read_chunk("05-results/WKBBS-compare/compare-mps.r")
...
```{r cache=F, include=F}
#knitr::read_chunk("05-results/flhm-compare/compare-Mps.r")
knitr::read_chunk("05-results/WKBBS-compare/compare-pdetect.r")

```

```{r load-pdetect, include=F}

```

```{r graphs-pdetect, echo=F}
