...
model{
  ...
  for( r in 1:rivers){
    ...
    mu_dens[r]<-log(50)-0.5/2  #mu (log of median)
    
    # corrected 9 feb 2023 (also in Northern model) - info from Antti Rätv
    ...
    # betas: parr to smolt survival  - this is problematic part of model incl. poor convergence!
    ...
    for(i in 1:3){ # p and q age 0, 1, 2
